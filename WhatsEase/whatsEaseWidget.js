...
async function CreateWhatsappChatWidget(
  option = {
    brandSetting: {
      ...
      borderRadius: "25",
      brandImg: "WhatsEase_logo_square_2.png",
      brandImgData: null,
      brandName: "WhatsEase",
      brandSubTitle: "",
      ctaText: "Chat with us",
      welcomeText: "I have some questions about WhatsEase, \ncan you help?",
      messageText: "I’ve some questions about WhatsEase, can you help?",
  ...
  var defaultSvg = option.chatButtonSetting.ctaIconWhatsEase
    ...
    document.querySelector("#whatsapp-chat-widget")?.insertAdjacentHTML(
      ...
      `<div class='wa-chat-box'>
                 <img class='wa-chat-box-brand'
                    onError='this.src= "WhatsEase_logo_square_2.png";' 
        ...
        option.brandSetting.messageText ? option.brandSetting.messageText : ""
                ...
                <div class='wa-chat-box-poweredby'>
                    ...
                    Powered by <a rel="noopener noreffer" href="https://github.com/oTnarP/WhatsEase" target="_blank" class="wa-chat-box-poweredby-link">WhatsEase</a>
                </div>
            </div>
            `
    );
  ...
  var styles = `
          ...
          .wa-widget-send-button {
              ...
              min-width: 52px;
              border: ${
                option.chatButtonSetting.ctaIconWhatsEase ? "1px" : "0"
              } solid #363636;
              border-radius: 100px;
              visibility: visible;
